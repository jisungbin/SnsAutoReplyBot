package com.sungbin.reply.bot.api.school;
...
public class School {
    ...
    public static School.Region getAreaData(String area) {
        switch (area){
            case "서울": return Region.SEOUL;
            case "인천": return Region.INCHEON;
            case "부산": return Region.BUSAN;
            case "광주": return Region.GWANGJU;
            case "대전": return Region.DAEJEON;
            case "대구": return Region.DAEGU;
            case "세종": return Region.SEJONG;
            case "울산": return Region.ULSAN;
            case "경기": return Region.GYEONGGI;
            case "강원": return Region.KANGWON;
            case "충북": return Region.CHUNGBUK;
            case "충남": return Region.CHUNGNAM;
            case "경북": return Region.GYEONGBUK;
            case "경남": return Region.GYEONGNAM;
            case "전북": return Region.JEONBUK;
            case "전남": return Region.JEONNAM;
            case "제주": return Region.JEJU;
            default: return School.Region.SEOUL;
        }
    }
