package com.sungbin.reply.bot.widget;
    ...
    static class Setting {
        ...
        public Setting(Context context, AttributeSet attrs) {
            ...
            if (array != null) {
                ...
                circleColor = array.getInt(R.styleable.BubbleTab_bubbleTab_circleColor, Color.parseColor(Utils.readData(context, "accent", "#80d6ff")));
